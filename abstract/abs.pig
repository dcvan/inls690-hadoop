...
tab1 = load 'abs.txt' as (id1:chararray, word1:chararray);
tab2 = load 'abs.txt' as (id2:chararray, word2:chararray);
tab3 = join tab1 by word1, tab2 by word2;

-- remove tuples with two identical IDs -- 
tab3 = filter tab3 by id1 != id2;

-- count the number of words in common between any two docs --
...
-- generate records with strength above the threshold of 0.5 --
tab5 = filter tab5 by strength > 0.5;

-- persist the result --
store tab5 into 'abs-result';
